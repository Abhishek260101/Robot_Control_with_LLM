...
bool llama_msgs__msg__token_prob__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("llama_msgs.msg._token_prob.TokenProb", full_classname_dest, 36) == 0);
  }
  llama_msgs__msg__TokenProb * ros_message = _ros_message;
  {  // token
  ...
  {  // token_text
    PyObject * field = PyObject_GetAttrString(_pymsg, "token_text");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->token_text, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of TokenProb */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("llama_msgs.msg._token_prob");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TokenProb");
  ...
  {  // token_text
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->token_text.data,
      strlen(ros_message->token_text.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "token_text", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
