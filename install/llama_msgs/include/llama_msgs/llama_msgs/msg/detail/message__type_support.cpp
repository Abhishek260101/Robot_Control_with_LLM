...
{
  new (message_memory) llama_msgs::msg::Message(_init);
}

void Message_fini_function(void * message_memory)
{
  auto typed_message = static_cast<llama_msgs::msg::Message *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Message_message_member_array[2] = {
  {
    ...
    offsetof(llama_msgs::msg::Message, role),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(llama_msgs::msg::Message, content),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::llama_msgs::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, llama_msgs, msg, Message)() {
  return &::llama_msgs::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
