...
static const _PartialResponse_type_support_symbol_names_t _PartialResponse_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, llama_msgs, msg, PartialResponse)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, llama_msgs, msg, PartialResponse)),
  }
};
...
{
  return &::llama_msgs::msg::rosidl_typesupport_cpp::PartialResponse_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, llama_msgs, msg, PartialResponse)() {
  return get_message_type_support_handle<llama_msgs::msg::PartialResponse>();
}
