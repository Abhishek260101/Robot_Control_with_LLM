...
static const _Tokenize_Request_type_support_symbol_names_t _Tokenize_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, llama_msgs, srv, Tokenize_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, llama_msgs, srv, Tokenize_Request)),
  }
};
...
{
  return &::llama_msgs::srv::rosidl_typesupport_cpp::Tokenize_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, llama_msgs, srv, Tokenize_Request)() {
  return get_message_type_support_handle<llama_msgs::srv::Tokenize_Request>();
}
...
static const _Tokenize_Response_type_support_symbol_names_t _Tokenize_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, llama_msgs, srv, Tokenize_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, llama_msgs, srv, Tokenize_Response)),
  }
};
...
{
  return &::llama_msgs::srv::rosidl_typesupport_cpp::Tokenize_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, llama_msgs, srv, Tokenize_Response)() {
  return get_message_type_support_handle<llama_msgs::srv::Tokenize_Response>();
}
...
static const _Tokenize_type_support_symbol_names_t _Tokenize_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, llama_msgs, srv, Tokenize)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, llama_msgs, srv, Tokenize)),
  }
};
...
{
  return &::llama_msgs::srv::rosidl_typesupport_cpp::Tokenize_service_type_support_handle;
}
