...
bool llama_msgs__msg__lo_ra__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("llama_msgs.msg._lo_ra.LoRA", full_classname_dest, 26) == 0);
  }
  llama_msgs__msg__LoRA * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of LoRA */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("llama_msgs.msg._lo_ra");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LoRA");
