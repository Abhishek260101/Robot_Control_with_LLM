...
bool llama_msgs__msg__message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("llama_msgs.msg._message.Message", full_classname_dest, 31) == 0);
  }
  llama_msgs__msg__Message * ros_message = _ros_message;
  {  // role
...
PyObject * llama_msgs__msg__message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("llama_msgs.msg._message");
