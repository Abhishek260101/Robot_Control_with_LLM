...
#ifndef LLAMA_MSGS__SRV__DETAIL__TOKENIZE__FUNCTIONS_H_
#define LLAMA_MSGS__SRV__DETAIL__TOKENIZE__FUNCTIONS_H_
...
/// Initialize srv/Tokenize message.
/**
...
/// Create srv/Tokenize message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * llama_msgs__srv__Tokenize_Request__init().
...
/// Destroy srv/Tokenize message.
/**
 * It calls
 * llama_msgs__srv__Tokenize_Request__fini()
...
/// Check for srv/Tokenize message equality.
/**
...
/// Initialize array of srv/Tokenize messages.
/**
...
/// Finalize array of srv/Tokenize messages.
/**
 * It calls
 * llama_msgs__srv__Tokenize_Request__fini()
...
/// Create array of srv/Tokenize messages.
/**
 * It allocates the memory for the array and calls
 * llama_msgs__srv__Tokenize_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Tokenize messages.
/**
 * It calls
 * llama_msgs__srv__Tokenize_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Tokenize message array equality.
/**
...
/// Copy an array of srv/Tokenize messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * llama_msgs__srv__Tokenize_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_llama_msgs
...
/**
 * It calls
 * llama_msgs__srv__Tokenize_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_llama_msgs
...
/**
 * It allocates the memory for the array and calls
 * llama_msgs__srv__Tokenize_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_llama_msgs
...
/**
 * It calls
 * llama_msgs__srv__Tokenize_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LLAMA_MSGS__SRV__DETAIL__TOKENIZE__FUNCTIONS_H_
