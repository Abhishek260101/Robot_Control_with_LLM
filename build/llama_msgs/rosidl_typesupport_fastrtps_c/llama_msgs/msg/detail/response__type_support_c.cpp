...
#include "llama_msgs/msg/detail/response__rosidl_typesupport_fastrtps_c.h"
...
using _Response__ros_msg_type = llama_msgs__msg__Response;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: probs
  {
    ...
    if (ros_message->probs.data) {
      llama_msgs__msg__TokenProbArray__Sequence__fini(&ros_message->probs);
    }
    if (!llama_msgs__msg__TokenProbArray__Sequence__init(&ros_message->probs, size)) {
...
static uint32_t _Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_llama_msgs__msg__Response(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = llama_msgs__msg__Response;
    is_plain =
      (
...
static size_t _Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_llama_msgs__msg__Response(
