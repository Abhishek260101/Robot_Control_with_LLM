...
#include "llama_msgs/msg/detail/message__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // content, role
#include "rosidl_runtime_c/string_functions.h"  // content, role

// forward declare type support functions


using _Message__ros_msg_type = llama_msgs__msg__Message;
...
static uint32_t _Message__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_llama_msgs__msg__Message(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = llama_msgs__msg__Message;
    is_plain =
      (
...
static size_t _Message__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_llama_msgs__msg__Message(
