...
#include "llama_msgs/msg/detail/response__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  // Member: probs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.probs[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = llama_msgs::msg::Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const llama_msgs::msg::Response *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<llama_msgs::msg::Response *>(
    untyped_ros_message);
...
{
  return &llama_msgs::msg::typesupport_fastrtps_cpp::_Response__handle;
}
