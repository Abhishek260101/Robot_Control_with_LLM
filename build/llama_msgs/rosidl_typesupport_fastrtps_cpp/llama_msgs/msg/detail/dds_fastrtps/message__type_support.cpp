...
#include "llama_msgs/msg/detail/message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const llama_msgs::msg::Message & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  llama_msgs::msg::Message & ros_message)
{
  // Member: role
  cdr >> ros_message.role;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = llama_msgs::msg::Message;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const llama_msgs::msg::Message *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<llama_msgs::msg::Message *>(
    untyped_ros_message);
...
{
  return &llama_msgs::msg::typesupport_fastrtps_cpp::_Message__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, llama_msgs, msg, Message)() {
  return &llama_msgs::msg::typesupport_fastrtps_cpp::_Message__handle;
}
