...
class Metaclass_GetTransform(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interface.srv.GetTransform')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_interface.srv import _get_transform
...
class GetTransform(metaclass=Metaclass_GetTransform):
    from robot_interface.srv._get_transform import GetTransform_Request as Request
    from robot_interface.srv._get_transform import GetTransform_Response as Response
