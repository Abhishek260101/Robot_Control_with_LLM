...
static const _GetTransform_Request_type_support_symbol_names_t _GetTransform_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interface, srv, GetTransform_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interface, srv, GetTransform_Request)),
  }
};
...
{
  return &::robot_interface::srv::rosidl_typesupport_cpp::GetTransform_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_interface, srv, GetTransform_Request)() {
  return get_message_type_support_handle<robot_interface::srv::GetTransform_Request>();
}
...
static const _GetTransform_Response_type_support_symbol_names_t _GetTransform_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interface, srv, GetTransform_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interface, srv, GetTransform_Response)),
  }
};
...
{
  return &::robot_interface::srv::rosidl_typesupport_cpp::GetTransform_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_interface, srv, GetTransform_Response)() {
  return get_message_type_support_handle<robot_interface::srv::GetTransform_Response>();
}
...
static const _GetTransform_type_support_symbol_names_t _GetTransform_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interface, srv, GetTransform)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interface, srv, GetTransform)),
  }
};
...
{
  return &::robot_interface::srv::rosidl_typesupport_cpp::GetTransform_service_type_support_handle;
}
