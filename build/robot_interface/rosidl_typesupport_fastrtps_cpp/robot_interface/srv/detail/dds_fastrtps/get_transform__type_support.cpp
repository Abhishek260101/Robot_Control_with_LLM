...
#include "robot_interface/srv/detail/get_transform__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interface::srv::GetTransform_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interface::srv::GetTransform_Request & ros_message)
{
  // Member: frame_id
  cdr >> ros_message.frame_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interface::srv::GetTransform_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interface::srv::GetTransform_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interface::srv::GetTransform_Request *>(
    untyped_ros_message);
...
{
  return &robot_interface::srv::typesupport_fastrtps_cpp::_GetTransform_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interface, srv, GetTransform_Request)() {
  return &robot_interface::srv::typesupport_fastrtps_cpp::_GetTransform_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_interface
cdr_serialize(
  const robot_interface::srv::GetTransform_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: transform
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interface::srv::GetTransform_Response & ros_message)
{
  // Member: transform
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_interface::srv::GetTransform_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interface::srv::GetTransform_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_interface::srv::GetTransform_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robot_interface::srv::typesupport_fastrtps_cpp::_GetTransform_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interface, srv, GetTransform_Response)() {
  return &robot_interface::srv::typesupport_fastrtps_cpp::_GetTransform_Response__handle;
}
...
{
  return &robot_interface::srv::typesupport_fastrtps_cpp::_GetTransform__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interface, srv, GetTransform)() {
  return &robot_interface::srv::typesupport_fastrtps_cpp::_GetTransform__handle;
}
