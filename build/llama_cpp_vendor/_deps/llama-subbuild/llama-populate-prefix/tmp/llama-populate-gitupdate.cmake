...
execute_process(
  COMMAND "/usr/bin/git" show-ref "b3735"
  WORKING_DIRECTORY "/home/abhishek/llm_robot_control/build/llama_cpp_vendor/_deps/llama-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("b3735" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/b3735")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/abhishek/llm_robot_control/build/llama_cpp_vendor/_deps/llama-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/abhishek/llm_robot_control/build/llama_cpp_vendor/_deps/llama-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
